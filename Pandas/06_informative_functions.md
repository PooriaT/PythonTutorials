---
id: 06_informative_functions
title: Informative Functions
sidebar_label: Informative Functions
slug: /06_informative_functions
---

---


There are some basic functions available in `pandas` which provide some useful information about the defined DataFrame.

- `df.axes`: returns a list representing the axes of the DataFrame. It has the row axis labels and column axis labels as the only members. They are returned in that order.
- `df.dtypes`: returns the dtypes in the DataFrame.
- `df.empty`: indicates whether DataFrame is empty. It will be True if DataFrame is entirely empty.
- `df.ndim`: returns the number of axes and array dimensions.
- `df.size`: returns the number of elements in this DataFrame object. it will return number of rows if Series. Otherwise return the number of
rows times number of columns if DataFrame.
- `df.values`: returns a Numpy representation of the DataFrame.
- `df.head(n=5)`: it will return the first `n` rows.
...
**************************************************
Axes:
 [RangeIndex(start=0, stop=128, step=1), Index(['LatD', ' "LatM"', ' "LatS"', ' "NS"', ' "LonD"', ' "LonM"', ' "LonS"',
       ' "EW"', ' "City"', ' "State"'],
      dtype='object')]
...
Values:
 ...
 [46 35 59 ... ' "W"' ' "Yakima"' ' WA']
 ...
 [40 10 48 ... ' "W"' ' "Red Bluff"' ' CA']
 [40 19 48 ... ' "W"' ' "Reading"' ' PA']
 [41 9 35 ... ' "W"' ' "Ravenna"' ' OH ']]
...
8    34       14       24   "N"       77       55       11   "W"   
9    39       45        0   "N"       75       33        0   "W"   
...
Last 10 rows:
      LatD   "LatM"   "LatS"  "NS"   "LonD"   "LonM"   "LonS"  "EW"  \
118    37       16       12   "N"       79       56       24   "W"   
119    37       32       24   "N"       77       26       59   "W"   
120    39       49       48   "N"       84       53       23   "W"   
121    38       46       12   "N"      112        5       23   "W"   
122    45       38       23   "N"       89       25       11   "W"   
